...
| Global learner context | Concept 14, architecture state boundaries | `~/.learning/` | `WORKSPACE-FORMAT.md` | Implemented |
| Local project context | S09, S11, S16; artifact loop | Project evidence scope | Workspace and programming references | Implemented |
| Curriculum sequencing | S01, S02, S09, S13 | Threshold and leverage graph | `design-learning-path` | Implemented |
...
| Logical learner and project state | [State contracts](STATE-CONTRACTS.md) | Evidence scopes and lifecycle | Workspace reference | Implemented |
| Sandbox and avoidance behavior | [Operational heuristics](OPERATIONAL-HEURISTICS.md) | Mode and environment gates | Programming reference | Implemented |
| Domain adapter format | [Domain adapter contract](DOMAIN-ADAPTER-CONTRACT.md) | Domain truth and probe library | Path-format reference | Implemented |
| Repository-shaped concise skills | [Reference shape](REFERENCE-SHAPE.md) | Drafting constraints | Two sub-100-line skill files | Implemented |
| Trigger and boundary behavior can be tested | [Evaluation scenarios](EVALUATION-SCENARIOS.md) | Forward-test contract | [Validation](VALIDATION.md) | Validated |
| Repository integration and validation are known | [Implementation readiness](IMPLEMENTATION-READINESS.md) | File layout and checks | Manifest and README integration | Validated |
| Skill boundary avoids trigger overlap | [Skill boundaries](SKILL-BOUNDARIES.md) | Skill metadata | Two initial skills | Implemented |
| Activation and naming | [Decision packet](DECISION-PACKET.md) | Trigger metadata | `learn-deeply`; explicit intent | Implemented |
| Persistence consent and location | [Decision packet](DECISION-PACKET.md) | State layer | Global `~/.learning/`; local `.learning/` | Implemented |

## Completion Interpretation

The corpus extraction and first skill derivation are complete. The specialized
programming skill and Socrates/Pi harness remain future derivatives, not missing
parts of the universal core.
